...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["M" /* NgModule */])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_24__services_user_service_client__["a" /* UserService */], __WEBPACK_IMPORTED_MODULE_25__services_website_service_client__["a" /* WebsiteService */], __WEBPACK_IMPORTED_MODULE_26__services_page_service_client__["a" /* PageService */], __WEBPACK_IMPORTED_MODULE_27__services_widget_service_client__["a" /* WidgetService */], __WEBPACK_IMPORTED_MODULE_31__services_flickr_service_client__["a" /* FlickrService */], __WEBPACK_IMPORTED_MODULE_32__services_shared_service__["a" /* SharedService */]],
...
var APP_ROUTES = [
    ...
    { path: 'profile/:uid/website/:wid/page/:pid/widget/:wgid/flickr', component: __WEBPACK_IMPORTED_MODULE_15__components_widget_widget_edit_widget_image_flickr_image_search_flickr_image_search_component__["a" /* FlickrImageSearchComponent */] },
];
    ...
    RegisterComponent.prototype.regSuccess = function () {
        ...
        this.userService.findUserByUsername(this.username)
            ...
            if (user === null) {
                ...
                _this.userService.createUser(newUser).subscribe(function (user1) {
                    console.log(user1);
                    _this.router.navigate(['/profile', user1._id]);
                    // if (user1) {
...
var FlickrImageSearchComponent = (function () {
    ...
    FlickrImageSearchComponent.prototype.selectPhoto = function (photo) {
        ...
        this.widgetService
            ...
            var result = data;
            if (result) {
                _this.router.navigate(['/profile/' + _this.userId + '/website/' + _this.websiteId + '/page/' + _this.pageId + '/widget/' + _this.widgetId]);
            }
            else {
                _this.error = 'failed!';
            }
